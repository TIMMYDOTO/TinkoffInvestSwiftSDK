...
public enum OrderDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [OrderDirection] = [
    .unspecified,
    .buy,
    .sell,
  ]
...
public enum OrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [OrderType] = [
    .unspecified,
    .limit,
    .market,
    .bestprice,
...
public enum OrderExecutionReportStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [OrderExecutionReportStatus] = [
...
public enum TimeInForceType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [TimeInForceType] = [
...
public enum OrderIdType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [OrderIdType] = [
    .unspecified,
    .exchange,
    .request,
  ]
...
public struct TradesStreamRequest: Sendable {
...
public struct TradesStreamResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public enum OneOf_Payload: Equatable, Sendable {
    ...
    case ping(Ping)
    ///Ответ на запрос на подписку.
    case subscription(SubscriptionResponse)
...
///Информация об исполнении торгового поручения.
public struct OrderTrades: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Информация о сделке.
public struct OrderTrade: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct PostOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var timeInForce: TimeInForceType = .timeInForceUnspecified
...
public struct PostOrderResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var responseMetadata: ResponseMetadata {
    get {return _storage._responseMetadata ?? ResponseMetadata()}
...
public struct PostOrderAsyncRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Алгоритм исполнения поручения, применяется только к лимитной заявке.
  public var timeInForce: TimeInForceType {
  ...
  fileprivate var _price: Quotation? = nil
  fileprivate var _timeInForce: TimeInForceType? = nil
  fileprivate var _priceType: PriceType? = nil
}

///Результат выставления асинхронного торгового поручения.
public struct PostOrderAsyncResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Текущий статус заявки.
  public var executionReportStatus: OrderExecutionReportStatus = .executionReportStatusUnspecified
...
public struct CancelOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Тип идентификатора заявки.
  public var orderIDType: OrderIdType {
  ...
  fileprivate var _orderIDType: OrderIdType? = nil
}

///Результат отмены торгового поручения.
public struct CancelOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Метадата
  public var responseMetadata: ResponseMetadata {
    get {return _responseMetadata ?? ResponseMetadata()}
  ...
  fileprivate var _responseMetadata: ResponseMetadata? = nil
}

///Запрос получения статуса торгового поручения.
public struct GetOrderStateRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetOrdersRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetOrdersResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct OrderStage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct ReplaceOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetMaxLotsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetMaxLotsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var buyLimits: GetMaxLotsResponse.BuyLimitsView {
    get {return _buyLimits ?? GetMaxLotsResponse.BuyLimitsView()}
  ...
  public var buyMarginLimits: GetMaxLotsResponse.BuyLimitsView {
    get {return _buyMarginLimits ?? GetMaxLotsResponse.BuyLimitsView()}
  ...
  public var sellLimits: GetMaxLotsResponse.SellLimitsView {
    get {return _sellLimits ?? GetMaxLotsResponse.SellLimitsView()}
  ...
  public var sellMarginLimits: GetMaxLotsResponse.SellLimitsView {
    get {return _sellMarginLimits ?? GetMaxLotsResponse.SellLimitsView()}
  ...
  public struct BuyLimitsView: Sendable {
    ...
    public var buyMoneyAmount: Quotation {
      get {return _buyMoneyAmount ?? Quotation()}
    ...
    fileprivate var _buyMoneyAmount: Quotation? = nil
  }
  ...
  fileprivate var _buyLimits: GetMaxLotsResponse.BuyLimitsView? = nil
  fileprivate var _buyMarginLimits: GetMaxLotsResponse.BuyLimitsView? = nil
  fileprivate var _sellLimits: GetMaxLotsResponse.SellLimitsView? = nil
  fileprivate var _sellMarginLimits: GetMaxLotsResponse.SellLimitsView? = nil
}

///Запрос получения предварительной стоимости заявки
public struct GetOrderPriceRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetOrderPriceResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var initialOrderAmount: MoneyValue {
    get {return _storage._initialOrderAmount ?? MoneyValue()}
  ...
  public var executedCommissionRub: MoneyValue {
    get {return _storage._executedCommissionRub ?? MoneyValue()}
  ...
  public var dealCommission: MoneyValue {
    get {return _storage._dealCommission ?? MoneyValue()}
  ...
  public enum OneOf_InstrumentExtra: Equatable, Sendable {
    ///Дополнительная информация по облигациям
    case extraBond(GetOrderPriceResponse.ExtraBond)
    ///Дополнительная информация по фьючерсам
    case extraFuture(GetOrderPriceResponse.ExtraFuture)
  ...
  public struct ExtraBond: Sendable {
    ...
    public var aciValue: MoneyValue {
      get {return _aciValue ?? MoneyValue()}
    ...
    public var nominalConversionRate: Quotation {
      get {return _nominalConversionRate ?? Quotation()}
    ...
    fileprivate var _aciValue: MoneyValue? = nil
    fileprivate var _nominalConversionRate: Quotation? = nil
  }
  ...
  public struct ExtraFuture: Sendable {
    ...
    public var initialMargin: MoneyValue {
      get {return _initialMargin ?? MoneyValue()}
    ...
    fileprivate var _initialMargin: MoneyValue? = nil
  }
...
public struct OrderStateStreamRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SubscriptionResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Статус подписки.
  public var status: ResultSubscriptionStatus = .unspecified
  ...
  fileprivate var _error: ErrorDetail? = nil
}

///Информация по заявкам
public struct OrderStateStreamResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var payload: OrderStateStreamResponse.OneOf_Payload? = nil

  ///Информация об исполнении торгового поручения.
  public var orderState: OrderStateStreamResponse.OrderState {
    get {
      if case .orderState(let v)? = payload {return v}
      return OrderStateStreamResponse.OrderState()
    }
  ...
  public enum OneOf_Payload: Equatable, Sendable {
    ///Информация об исполнении торгового поручения.
    case orderState(OrderStateStreamResponse.OrderState)
    ///Проверка активности стрима.
    case ping(Ping)
    ///Ответ на запрос на подписку.
    case subscription(SubscriptionResponse)
  ...
  public enum MarkerType: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [OrderStateStreamResponse.MarkerType] = [
      .markerUnknown,
      .markerBroker,
      .markerChat,
      .markerPaper,
  ...
  public enum StatusCauseInfo: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static let allCases: [OrderStateStreamResponse.StatusCauseInfo] = [
      .causeUnspecified,
  ...
  public struct OrderState: @unchecked Sendable {
    ...
    public var statusInfo: OrderStateStreamResponse.StatusCauseInfo {
    ...
    public var orderPrice: MoneyValue {
      get {return _storage._orderPrice ?? MoneyValue()}
    ...
    public var amount: MoneyValue {
      get {return _storage._amount ?? MoneyValue()}
    ...
    ///Спецсимвол.
    public var marker: OrderStateStreamResponse.MarkerType {
...
extension TimeInForceType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension OrderIdType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension PostOrderResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _responseMetadata: ResponseMetadata? = nil
...
extension PostOrderAsyncRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: PostOrderAsyncRequest, rhs: PostOrderAsyncRequest) -> Bool {
    if lhs.instrumentID != rhs.instrumentID {return false}
    if lhs.quantity != rhs.quantity {return false}
    if lhs._price != rhs._price {return false}
    if lhs.direction != rhs.direction {return false}
...
extension PostOrderAsyncResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: PostOrderAsyncResponse, rhs: PostOrderAsyncResponse) -> Bool {
...
extension GetMaxLotsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetMaxLotsRequest, rhs: GetMaxLotsRequest) -> Bool {
    if lhs.accountID != rhs.accountID {return false}
    if lhs.instrumentID != rhs.instrumentID {return false}
    if lhs._price != rhs._price {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension GetMaxLotsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetMaxLotsResponse, rhs: GetMaxLotsResponse) -> Bool {
...
extension GetMaxLotsResponse.BuyLimitsView: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = GetMaxLotsResponse.protoMessageName + ".BuyLimitsView"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: GetMaxLotsResponse.BuyLimitsView, rhs: GetMaxLotsResponse.BuyLimitsView) -> Bool {
...
extension GetMaxLotsResponse.SellLimitsView: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = GetMaxLotsResponse.protoMessageName + ".SellLimitsView"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: GetMaxLotsResponse.SellLimitsView, rhs: GetMaxLotsResponse.SellLimitsView) -> Bool {
...
extension GetOrderPriceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: GetOrderPriceRequest, rhs: GetOrderPriceRequest) -> Bool {
    if lhs.accountID != rhs.accountID {return false}
    if lhs.instrumentID != rhs.instrumentID {return false}
    if lhs._price != rhs._price {return false}
    if lhs.direction != rhs.direction {return false}
...
extension GetOrderPriceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _totalOrderAmount: MoneyValue? = nil
    var _initialOrderAmount: MoneyValue? = nil
    var _lotsRequested: Int64 = 0
    var _executedCommission: MoneyValue? = nil
    var _executedCommissionRub: MoneyValue? = nil
    var _serviceCommission: MoneyValue? = nil
    var _dealCommission: MoneyValue? = nil
    var _instrumentExtra: GetOrderPriceResponse.OneOf_InstrumentExtra?
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try {
          var v: GetOrderPriceResponse.ExtraBond?
          var hadOneofValue = false
        ...
        case 13: try {
          var v: GetOrderPriceResponse.ExtraFuture?
          var hadOneofValue = false
          if let current = _storage._instrumentExtra {
            hadOneofValue = true
  ...
  public static func ==(lhs: GetOrderPriceResponse, rhs: GetOrderPriceResponse) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension GetOrderPriceResponse.ExtraBond: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = GetOrderPriceResponse.protoMessageName + ".ExtraBond"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: GetOrderPriceResponse.ExtraBond, rhs: GetOrderPriceResponse.ExtraBond) -> Bool {
...
extension GetOrderPriceResponse.ExtraFuture: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = GetOrderPriceResponse.protoMessageName + ".ExtraFuture"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: GetOrderPriceResponse.ExtraFuture, rhs: GetOrderPriceResponse.ExtraFuture) -> Bool {
...
extension OrderStateStreamRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: OrderStateStreamRequest, rhs: OrderStateStreamRequest) -> Bool {
    if lhs.accounts != rhs.accounts {return false}
...
extension SubscriptionResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension OrderStateStreamResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: OrderStateStreamResponse.OrderState?
        var hadOneofValue = false
        if let current = self.payload {
          hadOneofValue = true
  ...
  public static func ==(lhs: OrderStateStreamResponse, rhs: OrderStateStreamResponse) -> Bool {
    if lhs.payload != rhs.payload {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension OrderStateStreamResponse.MarkerType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension OrderStateStreamResponse.StatusCauseInfo: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension OrderStateStreamResponse.OrderState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = OrderStateStreamResponse.protoMessageName + ".OrderState"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "order_id"),
  ...
  fileprivate class _StorageClass {
    ...
    var _executionReportStatus: OrderExecutionReportStatus = .executionReportStatusUnspecified
    var _statusInfo: OrderStateStreamResponse.StatusCauseInfo? = nil
    var _ticker: String = String()
    var _classCode: String = String()
    var _lotSize: Int32 = 0
    var _direction: OrderDirection = .unspecified
    var _timeInForce: TimeInForceType = .timeInForceUnspecified
    var _orderType: OrderType = .unspecified
    var _accountID: String = String()
    var _initialOrderPrice: MoneyValue? = nil
    var _orderPrice: MoneyValue? = nil
    var _amount: MoneyValue? = nil
    var _executedOrderPrice: MoneyValue? = nil
    var _currency: String = String()
    var _lotsRequested: Int64 = 0
    var _lotsExecuted: Int64 = 0
    ...
    var _marker: OrderStateStreamResponse.MarkerType? = nil
    var _trades: [OrderTrade] = []
  ...
  public static func ==(lhs: OrderStateStreamResponse.OrderState, rhs: OrderStateStreamResponse.OrderState) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
