...
public enum StopOrderDirection: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [StopOrderDirection] = [
    .unspecified,
    .buy,
    .sell,
  ]
...
public enum StopOrderExpirationType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [StopOrderExpirationType] = [
    .unspecified,
    .goodTillCancel,
    .goodTillDate,
  ]
...
///Тип стоп-заявки.
public enum StopOrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [StopOrderType] = [
    .unspecified,
    .takeProfit,
    .stopLoss,
    .stopLimit,
...
///Статус стоп-заяки.
public enum StopOrderStatusOption: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [StopOrderStatusOption] = [
...
public enum ExchangeOrderType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [ExchangeOrderType] = [
    .unspecified,
    .market,
    .limit,
  ]
...
public enum TakeProfitType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [TakeProfitType] = [
    .unspecified,
    .regular,
    .trailing,
  ]
...
public enum TrailingValueType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [TrailingValueType] = [
...
public enum TrailingStopStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [TrailingStopStatus] = [
...
public struct PostStopOrderRequest: @unchecked Sendable {
  ...
  public var price: Quotation {
    get {return _storage._price ?? Quotation()}
  ...
  public var stopPrice: Quotation {
    get {return _storage._stopPrice ?? Quotation()}
  ...
  public var expirationType: StopOrderExpirationType {
    get {return _storage._expirationType}
    set {_uniqueStorage()._expirationType = newValue}
  }

  ///Тип заявки.
  public var stopOrderType: StopOrderType {
  ...
  public var exchangeOrderType: ExchangeOrderType {
  ...
  public var trailingData: PostStopOrderRequest.TrailingData {
    get {return _storage._trailingData ?? PostStopOrderRequest.TrailingData()}
  ...
  public struct TrailingData: Sendable {
    ...
    public var indentType: TrailingValueType = .trailingValueUnspecified

    ///Размер защитного спреда.
    public var spread: Quotation {
      get {return _spread ?? Quotation()}
    ...
    public var spreadType: TrailingValueType = .trailingValueUnspecified

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _indent: Quotation? = nil
    fileprivate var _spread: Quotation? = nil
  }
...
public struct PostStopOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct GetStopOrdersRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///Статус заявок.
  public var status: StopOrderStatusOption = .stopOrderStatusUnspecified
...
public struct GetStopOrdersResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CancelStopOrderRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct CancelStopOrderResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct StopOrder: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var trailingData: StopOrder.TrailingData {
    get {return _storage._trailingData ?? StopOrder.TrailingData()}
    set {_uniqueStorage()._trailingData = newValue}
  }
  /// Returns true if `trailingData` has been explicitly set.
  public var hasTrailingData: Bool {return _storage._trailingData != nil}
  ...
  public struct TrailingData: Sendable {
    ...
    ///Статус трейлинг-стопа.
    public var status: TrailingStopStatus = .trailingStopUnspecified
    ...
    fileprivate var _extr: Quotation? = nil
  }
...
extension StopOrderStatusOption: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension ExchangeOrderType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension TakeProfitType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension TrailingValueType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension TrailingStopStatus: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension PostStopOrderRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _price: Quotation? = nil
    var _stopPrice: Quotation? = nil
    var _direction: StopOrderDirection = .unspecified
    var _accountID: String = String()
    var _expirationType: StopOrderExpirationType = .unspecified
    var _stopOrderType: StopOrderType = .unspecified
    var _expireDate: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _instrumentID: String = String()
    var _exchangeOrderType: ExchangeOrderType = .unspecified
    var _takeProfitType: TakeProfitType = .unspecified
    var _trailingData: PostStopOrderRequest.TrailingData? = nil
    var _priceType: PriceType = .unspecified
...
extension PostStopOrderRequest.TrailingData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = PostStopOrderRequest.protoMessageName + ".TrailingData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "indent"),
  ...
  public static func ==(lhs: PostStopOrderRequest.TrailingData, rhs: PostStopOrderRequest.TrailingData) -> Bool {
...
extension StopOrder: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _takeProfitType: TakeProfitType = .unspecified
    var _trailingData: StopOrder.TrailingData? = nil
    var _status: StopOrderStatusOption = .stopOrderStatusUnspecified
    var _exchangeOrderType: ExchangeOrderType = .unspecified
...
extension StopOrder.TrailingData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = StopOrder.protoMessageName + ".TrailingData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "indent"),
    2: .standard(proto: "indent_type"),
    3: .same(proto: "spread"),
  ...
  public static func ==(lhs: StopOrder.TrailingData, rhs: StopOrder.TrailingData) -> Bool {
    if lhs._indent != rhs._indent {return false}
    if lhs.indentType != rhs.indentType {return false}
    if lhs._spread != rhs._spread {return false}
    if lhs.spreadType != rhs.spreadType {return false}
